...
def get_movie_poster(movie_id):
    ...
    return "https://image.tmdb.org/t/p/w500" + movie_details['poster_path']
...
def get_movie_rating(movie_id):
    movie_details = get_movie_details(movie_id)
    return movie_details['vote_average']
...
def get_movie_release_date(movie_id):
    movie_details = get_movie_details(movie_id)
    return movie_details['release_date']

def get_movie_runtime(movie_id):
    movie_details = get_movie_details(movie_id)
    return movie_details['runtime']

def get_movie_status(movie_id):
    movie_details = get_movie_details(movie_id)
    return movie_details['status']
